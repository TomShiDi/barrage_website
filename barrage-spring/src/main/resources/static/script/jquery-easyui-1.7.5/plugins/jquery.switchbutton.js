...
(function ($) {
    ...
    function _7(_8, _9) {
        ...
        _c.find(".switchbutton-on").css({
            width: (w - _e / 2) + "px",
            textIndent: (_b.reversed ? "" : "-") + _e / 2 + "px"
        });
        _c.find(".switchbutton-off").css({
            width: (w - _e / 2) + "px",
            textIndent: (_b.reversed ? "-" : "") + _e / 2 + "px"
        });
        _b.marginWidth = w - _e;
    ...
    $.fn.switchbutton = function (_33, _34) {
        ...
        return this.each(function () {
            ...
            if (_35) {
                ...
                _35 = $.data(this, "switchbutton", {
                    options: $.extend({}, $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this), _33),
                    switchbutton: _2(this)
                });
            }
    ...
    $.fn.switchbutton.parseOptions = function (_3b) {
        var t = $(_3b);
        return $.extend({}, $.parser.parseOptions(_3b, ["onText", "offText", "handleText", {
            handleWidth: "number",
            reversed: "boolean"
