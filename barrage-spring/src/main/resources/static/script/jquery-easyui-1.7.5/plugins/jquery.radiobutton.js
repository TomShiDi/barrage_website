...
(function ($) {
    ...
    $.fn.radiobutton = function (_24, _25) {
        ...
        return this.each(function () {
            ...
            if (_26) {
                ...
                _26 = $.data(this, "radiobutton", {
                    options: $.extend({}, $.fn.radiobutton.defaults, $.fn.radiobutton.parseOptions(this), _24),
                    radiobutton: _2(this)
                });
            }
    ...
    $.fn.radiobutton.parseOptions = function (_2a) {
        var t = $(_2a);
        return $.extend({}, $.parser.parseOptions(_2a, ["label", "labelPosition", "labelAlign", {labelWidth: "number"}]), {
