...
(function ($) {
    ...
    function _59(_5a) {
        ...
        if (_5c.pagination) {
            ...
            _64.pagination({
                total: 0,
                pageNumber: _5c.pageNumber,
                pageSize: _5c.pageSize,
                pageList: _5c.pageList,
            ...
            if (col && col.editor) {
                ...
                if (_176) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _176,
                        target: _176.init(cell.find("td"), $.extend({height: opts.editorHeight}, _175)),
                        field: _173,
                        type: _174,
                        oldHtml: _177
                    });
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            var opts = $.extend(_1df, {
                width: _1e0.width,
                height: _1e0.height,
                closed: _1e0.closed,
                collapsed: _1e0.collapsed,
                minimized: _1e0.minimized,
                maximized: _1e0.maximized
            });
            return opts;
