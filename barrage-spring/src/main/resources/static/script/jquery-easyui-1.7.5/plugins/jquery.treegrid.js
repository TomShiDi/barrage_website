...
(function ($) {
    ...
    $.fn.treegrid = function (_cd, _ce) {
        ...
        return this.each(function () {
            ...
            if (_d0) {
                ...
                _d0 = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _cd),
                    data: [],
                    checkedRows: [],
                    tmpIds: []
                });
    ...
    $.fn.treegrid.parseOptions = function (_e5) {
        return $.extend({}, $.fn.datagrid.parseOptions(_e5), $.parser.parseOptions(_e5, ["treeField", {
            checkbox: "boolean",
            cascadeCheck: "boolean",
            onlyLeafCheck: "boolean"
        }, {animate: "boolean"}]));
    };
    var _e6 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_e7, _e8, _e9) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        loader: function (_128, _129, _12a) {
