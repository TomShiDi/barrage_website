...
<div class="tipImgArea">
    <img id="tipImg" style="z-index: 2" src="pic/phone-reverse.gif">
    <span style="position: absolute;top: 50%;z-index: 3;">请解除手机屏幕锁定，并将手机横屏放置</span>
</div>
<script type="text/javascript" src="script/index-2-pro.js?t=1.1.4"></script>
